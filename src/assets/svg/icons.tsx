...
export function DocumentLoading( {size = 20, color = "000" } ) {
  ...
  return (
    ...
    >
      <path
        fill={color}
        d="M16 9.5a1 1 0 102 0h-2zM9 22a1 1 0 100-2v2zm-7.673-2.638l.891-.454-.891.454zm1.311 1.311l-.454.891.454-.891zM15.362 1.327l.454-.891-.454.891zm1.311 1.311l-.891.454.891-.454zM2.638 1.327l.454.891-.454-.891zM1.327 2.638l.891.454-.891-.454zM11 11a1 1 0 100-2v2zM5 9a1 1 0 000 2V9zm2 6a1 1 0 100-2v2zm-2-2a1 1 0 100 2v-2zm8-6a1 1 0 100-2v2zM5 5a1 1 0 000 2V5zm7 12a1 1 0 10-2 0h2zm3-5a1 1 0 100 2v-2zM5.8 2h6.4V0H5.8v2zM2 16.2V5.8H0v10.4h2zM16 5.8v3.7h2V5.8h-2zM9 20H5.8v2H9v-2zm-9-3.8c0 .824 0 1.501.044 2.052.046.562.145 1.079.392 1.564l1.782-.908c-.08-.156-.145-.38-.18-.819C2 17.639 2 17.057 2 16.2H0zM5.8 20c-.857 0-1.439 0-1.889-.038-.438-.035-.663-.1-.819-.18l-.908 1.782c.485.247 1.002.346 1.564.392C4.298 22 4.976 22 5.8 22v-2zm-5.364-.184a4 4 0 001.748 1.748l.908-1.782a2 2 0 01-.874-.874l-1.782.908zM12.2 2c.857 0 1.439 0 1.889.038.438.035.663.1.819.18l.908-1.782C15.331.189 14.814.09 14.252.044 13.702 0 13.024 0 12.2 0v2zM18 5.8c0-.824 0-1.501-.044-2.052-.046-.562-.145-1.079-.392-1.564l-1.782.908c.08.156.145.38.18.819C16 4.361 16 4.943 16 5.8h2zm-3.092-3.582a2 2 0 01.874.874l1.782-.908A4 4 0 0015.816.436l-.908 1.782zM5.8 0c-.824 0-1.501 0-2.052.044C3.186.09 2.67.19 2.184.436l.908 1.782c.156-.08.38-.145.819-.18C4.361 2 4.943 2 5.8 2V0zM2 5.8c0-.857 0-1.439.038-1.889.035-.438.1-.663.18-.819L.436 2.184C.189 2.669.09 3.186.044 3.748 0 4.298 0 4.976 0 5.8h2zM2.184.436A4 4 0 00.436 2.184l1.782.908a2 2 0 01.874-.874L2.184.436zM11 9H5v2h6V9zm-4 4H5v2h2v-2zm6-8H5v2h8V5zm5 12a3 3 0 01-3 3v2a5 5 0 005-5h-2zm-3 3a3 3 0 01-3-3h-2a5 5 0 005 5v-2zm0-6a3 3 0 013 3h2a5 5 0 00-5-5v2z"
      ></path>
    </svg>
  );
}
